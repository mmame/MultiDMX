...
#define DEFAULT_STEPPER_TMC2209_CURRENT 600
#define DEFAULT_STEPPER_SCALE 100
#define DEFAULT_STEPPER_STALL_THRESHOLD 5
#define DEFAULT_STEPPER_MAX_SPEED 2000
#define DEFAULT_STEPPER_HOMING_SPEED 1000
#define DEFAULT_STEPPER_ACCEL 500
#define DEFAULT_STEPPER_HOMING_TIMEOUT_MS 5000
#define DEFAULT_STEPPER_HOMING_STEP_LIMIT 50000
